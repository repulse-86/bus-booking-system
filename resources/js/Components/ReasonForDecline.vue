...
<template>
    <div v-if="reason" class="bg-yellow-50 dark:bg-yellow-900 p-6 rounded-lg shadow-md border border-yellow-200 dark:border-yellow-700">
        ...
        <p class="text-yellow-800 dark:text-yellow-300 mt-2">{{ reason }}</p>
    </div>
</template>
